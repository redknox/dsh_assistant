...
The current v0.5.0 baseline covers the governed construction/control substrate, the first bounded Capability Specification/Evaluation experience, one host-rendered expense-risk surface, and Experimental external development executors. Reusable domain kits, generated product UI schemas, real finance adapters, and composition of multiple capabilities into a complete professional application remain later milestones. See [docs/product-vision.md](./docs/product-vision.md) and [docs/v0.5.0-baseline.md](./docs/v0.5.0-baseline.md).

## Evidence

This document is **Implemented** as a contract. Runtime boot, local persistence, the UI control surface, the DSH bundle/profile pack, the installable `tars-ng` command, Capability Registry/Resolution, candidate validation, independent review, governed activation/recovery, context endurance, bounded task/workbench controls, and governed catalogs are covered by `npm test`. Provider-backed live availability remains configuration-dependent. Calendar and Obsidian generated vertical E2E tests are quarantined pending isolated-runtime Broker migration. Codex and Claude authoring adapters are **Experimental** until bounded live runs are accepted. Vendor OAuth refresh, hosted persistence, vector retrieval, mobile/public UI, autonomous approval, and production security certification are **Unsupported**. See [docs/operator.md](./docs/operator.md), [docs/packaging.md](./docs/packaging.md), [docs/v0.5.0-baseline.md](./docs/v0.5.0-baseline.md), [docs/capability-registry.md](./docs/capability-registry.md), [docs/capability-resolution.md](./docs/capability-resolution.md), [docs/candidate-workspace.md](./docs/candidate-workspace.md), [docs/extension-governance.md](./docs/extension-governance.md), and [docs/mission-control-workspace.md](./docs/mission-control-workspace.md).
