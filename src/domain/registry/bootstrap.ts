...
export const CORE_BOOTSTRAP_INVENTORY: readonly RegistryRegisterInput[] = [
  ...
  },
  {
    ...
    status: 'active',
    evidence: 'Verified',
    capabilities: [{ id: 'web.search', permissions: ['external.deepseek.web.search'] }],
    permissions: ['external.deepseek.web.search'],
    runtimeSeams: ['web.search'],
    provider: 'deepseek',
    tools: ['web_search'],
    services: ['web', 'governedWeb'],
    providers: ['deepseek'],
  },
  {
