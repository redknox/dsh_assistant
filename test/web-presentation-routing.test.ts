...
describe('Web UI presentation routing', () => {
  it('maps canonical workspace hashes and preserves the conversations alias', () => {
    ...
    assert.equal(workspacePaneFromHash('#capabilities'), 'capabilities')
    ...
    assert.equal(workspacePaneFromHash('#system-info'), 'system-info')
    assert.equal(workspacePaneFromHash('#specifications'), 'specifications')
    assert.equal(workspacePaneFromHash('#tools'), 'tools')
    assert.equal(workspacePaneFromHash('#workflows'), 'workflows')
  ...
  it('writes only canonical workspace hashes', () => {
    ...
    assert.equal(workspacePaneHash('capabilities'), '#capabilities')
    ...
    assert.equal(workspacePaneHash('system-info'), '#system-info')
    assert.equal(workspacePaneHash('specifications'), '#specifications')
    assert.equal(workspacePaneHash('tools'), '#tools')
    assert.equal(workspacePaneHash('workflows'), '#workflows')
  })
