...
Known limitations: no OAuth refresh, no production security certification, no durable user-level Schedule, no mobile distribution, no public npm publish. Release status: [docs/RELEASE.md](./docs/RELEASE.md). Soak baseline: [docs/v0.3.0-seal.md](./docs/v0.3.0-seal.md).
