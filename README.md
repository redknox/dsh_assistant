...
| Self-Extension governance | no | **Verified** | Registry → review → candidate → exact-diff approval → activate → rollback. First slice: [docs/obsidian-self-extension.md](./docs/obsidian-self-extension.md). Autonomous install remains **Unsupported** |
