...
6. The Capability Registry is descriptive only. Do not implement a generated-plugin installer, autonomous writer, or resolution engine unless a later issue asks for it.
