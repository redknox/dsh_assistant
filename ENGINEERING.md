...
6. The Capability Registry is descriptive only. Capability Resolution Review is advisory only and must not install, approve, or mount anything. Do not implement a generated-plugin installer or autonomous writer unless a later issue asks for it.
